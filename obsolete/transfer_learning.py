...
def transfer_learning_train(num_iterations, resume = False, feature_extraction_phase1 = feature_extraction_status.feature_extraction):
    fc2, fc3, cost = leNet.get_training_model(enable_dropout = True, feature_extraction_phase = feature_extraction_phase1)
...
transfer_learning_train(20, resume = False, feature_extraction_phase1 = feature_extraction_status.feature_extraction)
